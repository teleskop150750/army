                                ...
                                <?php if (!isset($_SESSION['user'])) : ?>
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" name="login" class="form-control" id="login"
                                               placeholder="Login"
                                               value="<?= $_SESSION['form_data']['login'] ?? '' ?>"
                                               required>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="password" name="password" class="form-control" id="pasword"
                                               ...
                                               value="<?= $_SESSION['form_data']['password'] ?? '' ?>"
                                               data-minlength="6"
                                               data-error="Пароль должен включать не менее 6 символов" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" name="address" class="form-control" id="address"
                                               placeholder="Address"
                                               value="<?= $_SESSION['form_data']['address'] ?? '' ?>"
                                               required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                <?php endif; ?>
